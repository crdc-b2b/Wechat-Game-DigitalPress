...
const NUM_ICON_WIDTH   = 200
const NUM_ICON_HEIGHT  = 200
...
export default class BgIcon extends Sprite {
    constructor(num) {
        super(NUM_ICON_SRC + 'b' + num + '.png', NUM_ICON_WIDTH, NUM_ICON_HEIGHT, 0, 0)
        this.number = 'b' + num
    }
